        ...
        try {
            ...
            try {
                ...
                if ($sourceExists) {
                    ...
                    Write-EnhancedLog -Message "Event log source '$global:sanitizedsourceName' exists in log '$global:sanitizedlogName'. Number of occurrences: $sourceCount." -Level "INFO"
                }
                else {
